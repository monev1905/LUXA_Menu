...
export default function MenuContent({ menuData }: MenuContentProps) {
  ...
  // Get venue data (first venue)
  const venue = menuData.venues[0];
  const venueName = venue?.name || "Menu";
  const venueSubtitle = venue?.subtitle || "";
    ...
    <div className="min-h-screen flex flex-col relative overflow-x-hidden">
      ...
      >
        <defs>
          ...
          >
            <polygon
              points="24,0 48,13.856 48,41.568 24,55.425 0,41.568 0,13.856"
              fill="none"
      ...
      >
        <div
          className="absolute w-[150%] h-[60%] left-[-25%] top-[40%] opacity-10 rotate-12 animate-shine"
          style={{
            background:
              "linear-gradient(120deg, rgba(255,255,255,0.18) 0%, rgba(255,255,255,0.04) 60%, rgba(255,255,255,0) 100%)",
          }}
        />
      </div>
        ...
        {!tabParam ? (
          ...
          sectionParam ? (
            <DrinksList
              ...
              drinkCategories={menuData.drinkCategories}
            />
          ) : (
            <DrinksMenu
              sectionParam={sectionParam}
          ...
          <ShishaMenu
            ...
            shishaSelections={menuData.shishaSelections}
            shishaFlavors={menuData.shishaFlavors}
          />
        ) : null}
      </main>
