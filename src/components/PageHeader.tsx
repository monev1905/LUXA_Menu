    ...
    >
      ...
      <div className="absolute inset-0 flex items-center justify-center -z-5">
        <div className="text-center">
          <h2
            className="text-4xl md:text-6xl font-bold text-white/90 tracking-wider drop-shadow-2xl"
            style={{
              fontFamily: "CardFont, sans-serif",
          ...
          {subtitle && (
            <h3
              className="text-2xl md:text-4xl font-semibold text-white/80 tracking-wide drop-shadow-xl mt-2"
              style={{
                fontFamily: "CardFont, sans-serif",
